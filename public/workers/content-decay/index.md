---
title: "Content Decay & Refresh Priority Worker | WordPresto"
description: "Faye reviews freshness signals and content decay risk, helping editors decide whether a page is still current, needs monitoring, should be refreshed, or requires urgent review."
canonical: "https://wordpresto.com/workers/content-decay/"
worker: "Faye"
...
- Rewrite outdated content automatically
- Invent fresh examples, dates or evidence
- Schedule updates
- Publish or apply changes to a CMS
- Treat inferred freshness risk as confirmed ranking loss

## Workers Faye works alongside.

- **Nora — Content Inventory Worker**: Classifies the page as a content asset and identifies useful inventory signals. Output: Inventory review.
