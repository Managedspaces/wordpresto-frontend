...
## The funnel stopped being a funnel.

Nobody moves down a straight line from awareness to decision any more. They notice you somewhere, go quiet, ask people they trust, search for you by name, check whether you are credible, ask an AI to summarise you — and arrive already decided. Then they tell someone else, and it starts again.

- **Unprompted attention**: Almost nobody starts by searching for you. They start by noticing something worth their time, from someone they were already reading.
- **Saved for later**: Most of the journey is invisible. Work gets saved, forwarded and remembered long before anyone fills in a form.
- **Quiet research**: The research happens without you. By the time you hear from someone, they have usually made most of their mind up already.
- **Asks people they trust**: A recommendation from someone they already trust outweighs anything you say about yourself. This is the part of the funnel you cannot buy.
- **Searches by name**: A branded search is not the top of the funnel. It is evidence that something earlier in the loop already worked.
- **Reads the detail**: One genuinely useful page does the work of a sales call, and does it at three in the morning without you.
- **Checks you are credible**: Trust gets verified somewhere you do not control. What other customers said is part of your evidence whether you like it or not.
- **Asks an AI to summarise you**: An assistant answers from the whole picture, not one page. What it says about you is built out of every loop that came before it.
