...
export const seoWorkers: WorkerData[] = [
  ...
  },
  {
    ...
    summary: 'Reviews accessibility signals available in the page evidence, flagging weak heading structure, missing image alternatives, unclear link text and readability risks for editorial review.',
    output: 'Accessibility findings',
    image: '/agents/profiles/profile-24-192.webp',
    image2x: '/agents/profiles/profile-24-384.webp',
    teamColor: 'var(--team-seo)',
  },
  {
    id: 'seo_metadata',
