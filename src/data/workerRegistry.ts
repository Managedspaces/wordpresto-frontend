...
export const WORKERS: WorkerEntry[] = [
  ...
  { id: 'internal_linking', name: 'Leo', roleTitle: 'Content relationship specialist', department: 'Content Relationships', team: 'seo', status: 'available', slug: 'internal-linking', portrait: 9 },
  ...
  { id: 'site_discovery', name: 'Claire', roleTitle: 'Site discovery specialist', department: 'Site Discovery', team: 'seo', status: 'available', slug: 'site-discovery', portrait: 17 },
