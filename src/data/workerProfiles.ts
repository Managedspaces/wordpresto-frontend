...
export const workerProfiles: WorkerProfile[] = [
  ...
  // 35. Claire - Site Discovery Worker
  {
    id: 'site_discovery',
    slug: 'site-discovery',
    name: 'Claire',
    ...
    h1: 'Find the pages before the work begins.',
    heroPara1:
    ...
    heroTagPills: {
      ...
      output: 'Output · Site discovery review',
    },
    problemEyebrow: 'Where site projects get messy',
    problemH2: 'You cannot improve the content if you do not know what pages you are dealing with.',
    problemPara:
    ...
    problemAnnotation: '↘ discover the pages, then decide what needs work',
    beforeStamp: 'Messy starting point',
    beforeHtml: `<p>The team has a homepage, a few service pages and some blog posts, but no clear view of what should be reviewed first.</p>`,
    beforeTags: ['Pages scattered', 'Review priority unclear', 'Weak site picture', 'Hard to plan'],
    beforeNote: 'the project starts from fragments',
    afterStamp: 'Discovery review',
    afterHtml: `<p>Claire organises the known pages, highlights follow-up checks and prepares the site for deeper review.</p>`,
    afterTags: ['Clearer page list', 'Better review flow', 'Content signals visible', 'Ready for workers'],
    afterNote: 'the team knows where to begin',
    helpsEyebrow: 'How this Worker helps',
    helpsH2: 'A discovery layer for website projects.',
    helpsPara:
    ...
    ioH2: 'What Claire works from, and what she produces.',
    worksFrom: [
      'Website project',
      'Known site pages',
      'Site sections',
    ...
    willNot: [
      { color: 'red', text: 'Rewrite or edit content' },
      { color: 'red', text: 'Delete, merge or redirect pages' },
      { color: 'red', text: 'Publish or write to any CMS' },
      { color: 'red', text: 'Treat every discovered page as automatically important' },
      { color: 'red', text: 'Replace human review of site priorities' },
    ],
    relatedH2: 'Workers Claire works alongside.',
    relatedWorkerIds: [
      {
        id: 'page_inspector',
        description: 'Inspects individual pages once they are selected for review.',
        outputLabel: 'Page signals',
        ctaLabel: 'How Patrick inspects',
      },
      {
        id: 'content_inventory',
        description: 'Classifies pages as content assets and records planning signals.',
        outputLabel: 'Inventory review',
        ctaLabel: 'How Nora classifies',
      },
      {
        id: 'internal_linking',
        description: 'Reviews how selected pages connect to related content.',
        outputLabel: 'Link assessment',
        ctaLabel: 'How Leo reviews',
      },
    ],
    ctaH2: 'Give every website project a clearer starting point.',
    ctaPara:
