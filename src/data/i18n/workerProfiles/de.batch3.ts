...
export const deBatch3: Record<string, WorkerProfileTranslatable> = {
  clarity_proofing: {
    ...
    metaDescription:
      'Esme lektoriert Grammatik, Klarheit, Ton und risikobewusste Formulierungen und erstellt reine Review-Vorschläge, damit Redakteure den Text verbessern können, ohne die Kontrolle an die Automatisierung abzugeben.',
    h1: 'Den Text sauberer machen, bevor er ins Review geht.',
    heroPara1:
      'Gutes Lektorat ist mehr als Tippfehler zu korrigieren. Es bedeutet zu erkennen, wo ein Satz abdriftet, wo eine Formulierung fast richtig klingt, wo der Ton verrutscht ist und wo der Leser sich zu sehr anstrengen muss. Esme lektoriert den Text selbst: Grammatik, Rechtschreibung, Zeichensetzung, Klarheit, Prägnanz, Lesbarkeit, Ton, Konsistenz, Wiederholung, Wortwahl und risikobewusste Sprache. Sie erstellt reine Review-Vorschläge, damit Redakteure die Copy verbessern können, ohne die Kontrolle über die Seite an die Automatisierung abzugeben.',
    heroPara2:
    ...
    beforeHtml: `<p>Die Seite soll Nutzern helfen, das Leistungsangebot zu verstehen, und liefert eine Reihe unterschiedlicher Beispiele, die für Menschen nützlich sein könnten, die möglicherweise eine Buchung in Erwägung ziehen.</p>`,
    ...
    afterHtml: `<p>Die Seite erklärt die Leistung klar, gibt praktische Beispiele und hilft potenziellen Kunden bei der Entscheidung, ob sie buchen.</p>`,
  ...
  cannibalisation_overlap: {
    ...
    metaDescription:
      'Cleo prüft eine Seite auf Intentionskonflikte, Überschneidungsrisiken und unklare Content-Rollen und hilft Redakteuren zu entscheiden, ob eine Seite geschärft, gestützt, konsolidiert oder manuell gegen andere geprüft werden sollte.',
    h1: 'Seiten finden, die versuchen, zu viele Aufgaben zu erfüllen.',
    heroPara1:
      'Content-Kannibalisierung ist nicht nur ein websiteweites Ranking-Problem. Sie kann innerhalb einer einzelnen Seite beginnen: gemischte Intention, unklare redaktionelle Rolle, Metadaten, die das Falsche versprechen, dünne Abschnitte, die woanders hingehören, oder Seitentext, der mit einem anderen wahrscheinlichen Asset konkurriert. Cleo prüft eine Seite auf Intentionskonflikte, Überschneidungsrisiken und unklare Content-Rollen. Sie hilft Redakteuren zu entscheiden, ob die Seite geschärft, gestützt, konsolidiert oder manuell gegen andere Seiten geprüft werden sollte.',
    ...
    scenarios: [
      ...
      },
      {
        ...
        description: 'Sie hilft Redakteuren, die Seitenrolle zu schützen, bevor Textänderungen beginnen.',
      },
    ],
    ...
    boundaryChecklist: [
      ...
      'Manuelle Prüfungen werden klar aufgelistet, damit Redakteure wissen, was noch bestätigt werden muss.',
    ],
    willNot: [
    ...
    ctaPara:
      'Cleo hilft Redakteuren, Überschneidungsrisiken, gemischte Intentionen und Konsolidierungsfragen zu erkennen, bevor der Content weitergeht.',
  ...
  content_decay: {
    ...
    metaDescription:
      'Faye prüft Aktualitätssignale und das Risiko von Content-Verfall und hilft Redakteuren zu entscheiden, ob eine Seite noch aktuell ist, beobachtet, aufgefrischt oder dringend geprüft werden muss.',
    h1: 'Erkennen, wenn eine Seite anfängt, ihre Schärfe zu verlieren.',
    heroPara1:
      'Manche Seiten scheitern langsam. Der Text existiert noch, die URL lädt noch, aber die Belege sind alt, der Titel verspricht etwas Aktuelles, die Beispiele wirken überholt, oder das Thema hat sich weiterentwickelt. Faye prüft Aktualitätssignale und das Risiko von Content-Verfall. Sie hilft Redakteuren zu entscheiden, ob eine Seite noch aktuell ist, beobachtet werden muss, aufgefrischt werden sollte oder dringend geprüft werden muss.',
    heroPara2:
    ...
    problemPara:
      'Content-Verfall ist oft subtil. Ein Datum im Titel, ein altes Beispiel, eine unbelegte Aussage, ein veralteter Vergleich oder ein Seitentyp, der regelmäßige Aktualisierungen braucht, können Vertrauen und Performance schleichend verringern. Faye sucht nach den Signalen, die Redakteuren sagen, dass eine Seite Aufmerksamkeit braucht, bevor daraus ein größeres Ranking- oder Glaubwürdigkeitsproblem wird.',
    ...
    ctaPara:
      'Faye hilft Redakteuren, Content-Verfall, Prüfpriorität und Pflegerhythmus zu erkennen, bevor die Seite an Vertrauen verliert.',
  ...
  topical_authority: {
    ...
    metaDescription:
      'Zara prüft Signale zur thematischen Abdeckung und Content-Lücken und hilft Redakteuren zu erkennen, ob eine Seite stark wirkt, Unterstützung braucht, unvollständig ist oder einen breiteren Content-Plan erfordert.',
    h1: 'Erkennen, ob die Seite genug thematische Unterstützung hat.',
    heroPara1:
      'Eine Seite kann ihr Thema klar behandeln und trotzdem in einem schwachen Content-Cluster sitzen. Ihr können unterstützende Seiten fehlen, verwandte Unterthemen übersehen, sie kann zu weit von ihrem Hub entfernt sitzen oder eine thematische Rolle tragen, um die die Website nie richtig herumgebaut wurde. Zara prüft Signale zur thematischen Abdeckung und Content-Lücken. Sie hilft Redakteuren zu erkennen, ob eine Seite stark wirkt, Unterstützung braucht, unvollständig ist oder einen breiteren Content-Plan erfordert.',
    heroPara2:
    ...
    scenarios: [
      ...
      },
      {
        ...
        description: 'Sie gibt Redakteuren einen klareren Blick auf Themen-Tiefe und Abdeckungslücken.',
      },
    ],
    boundaryH2: 'Zara prüft die Abdeckung. Redakteure entscheiden den Content-Plan.',
    boundaryPara:
    ...
    ctaPara:
      'Zara hilft Redakteuren zu erkennen, wo eine Seite thematische Unterstützung, verwandte Assets oder eine bessere Cluster-Planung braucht.',
  ...
  conversion_alignment: {
    ...
    helpsPara:
      'Diane prüft Conversion-Signale, die in den Seitenbelegen bereits sichtbar sind. Sie führt keine A/B-Tests durch, greift nicht auf Analytics zu und schreibt keine Verkaufscopy automatisch um. Sie gibt Redakteuren eine praktische Einschätzung, ob die Seite zur Handlung anregt.',
    checks: [
    ...
    boundaryH2: 'Diane prüft den Pfad. Redakteure entscheiden die Änderung.',
    boundaryPara:
      'Diane führt keine Experimente durch, greift nicht auf Analytics zu, schreibt CTAs nicht automatisch um und garantiert keine Conversion-Verbesserung. Sie prüft die Ausrichtung und gibt menschlichen Redakteuren praktische Befunde.',
    boundaryChecklist: [
    ...
    ctaPara:
      'Diane hilft Redakteuren zu erkennen, ob die Seite dem Leser genug Vertrauen, Klarheit und Richtung für den nächsten Schritt gibt.',
  ...
  content_format_serp_fit: {
    ...
    helpsPara:
      'Ivan prüft die aktuelle Seitenform und vergleicht sie mit dem wahrscheinlich erwarteten Format. Er ruft keine Live-SERPs ab und schreibt die Seite nicht um. Er gibt Redakteuren eine strukturierte Formateinschätzung.',
    checks: [
    ...
    prepares: [
      ...
      'Überarbeitungshinweise für Redakteure',
    ],
    surfaces: [
    ...
    boundaryH2: 'Ivan empfiehlt die Form. Redakteure entscheiden die Struktur.',
    boundaryPara:
      'Ivan ruft keine Live-SERPs ab, schreibt die Seite nicht um, erstellt kein Schema und veröffentlicht keine Änderungen. Er prüft das Seitenformat und gibt Redakteuren eine strukturierte Empfehlung.',
    boundaryChecklist: [
    ...
    ctaPara:
      'Ivan hilft Redakteuren, das Format zu wählen, das zur Suchintention, Lesererwartung und dem Seitenzweck passt.',
  ...
  internal_link_pathway: {
    ...
    h1: 'Die Pfade prüfen, denen Leser und Crawler tatsächlich folgen können.',
    heroPara1:
      'Interne Links sind nicht nur SEO-Signale. Sie sind Wege durch die Website. Gute Links helfen Lesern, von der Frage zum Beleg, vom Leitfaden zur Leistung, von der Stützseite zur kommerziellen Seite und vom breiten Thema zur konkreten Handlung zu gelangen. Felix prüft die Gesundheit interner Link-Pfade: Waisenrisiko, Ankertext-Qualität, Hub-Spoke-Beziehungen, fehlende Links für den nächsten Schritt, konkurrierende Links und Pfadkohärenz.',
    heroPara2:
    ...
    helpsPara:
      'Felix prüft bereits sichtbare Seitensignale und den Link-Kontext. Er bearbeitet keine Anker, ruft keine verlinkten Seiten ab, crawlt nicht die gesamte Website und veröffentlicht keine Änderungen. Er gibt Redakteuren ein strukturiertes Pfad-Review.',
    checks: [
    ...
    improves: [
      'Bewegung der Leser durch die Website',
    ...
    scenarios: [
      ...
      {
        title: 'Redakteure planen Link-Verbesserungen.',
        description: 'Er gibt reviewbare Link-Maßnahmen, bevor jemand die Seite bearbeitet.',
      },
    ],
    boundaryH2: 'Felix prüft Pfade. Redakteure entscheiden über Link-Änderungen.',
    boundaryPara:
    ...
    ctaPara:
      'Felix hilft Redakteuren, lose Links in klare Leserpfade, Themenstützung und reviewbare Link-Maßnahmen zu verwandeln.',
  ...
  content_pruning_consolidation: {
    ...
    metaDescription:
      'Hugo prüft Signale zur Content-Pflege: Überschneidungsrisiko, dünner Content, Verfall, unklare Rolle, schwache Pfade und Konsolidierungsanstöße, und hilft Redakteuren, die sicherste nächste Pflegemaßnahme zu wählen.',
    h1: 'Entscheiden, ob schwacher Content verbessert, zusammengeführt oder belassen werden sollte.',
    heroPara1:
      'Nicht jede leistungsschwache Seite braucht eine Überarbeitung. Manche Seiten brauchen eine Auffrischung. Manche müssen konsolidiert werden. Manche sollten bleiben, weil sie einem engen, aber gültigen Zweck dienen. Manche brauchen eine sorgfältige Bereinigungsdiskussion, bevor die Website aufgebläht und unübersichtlich wird. Hugo prüft Signale zur Content-Pflege: Überschneidungsrisiko, dünner Content, Verfall, unklare Rolle, schwache Pfade und Konsolidierungsanstöße. Er hilft Redakteuren, die sicherste nächste Pflegemaßnahme zu wählen.',
    ...
    scenarios: [
      ...
      },
      {
        ...
        description: 'Er gibt Redakteuren einen sichereren Pflegepfad als blindes Löschen.',
      },
      {
    ...
    boundaryH2: 'Hugo empfiehlt die Pflege. Redakteure entscheiden die Maßnahme.',
    boundaryPara:
    ...
    ctaPara:
      'Hugo hilft Redakteuren zu entscheiden, ob eine Seite aufgefrischt, konsolidiert, geschützt oder geprüft werden sollte, bevor eine destruktive Maßnahme in Betracht gezogen wird.',
  ...
  content_inventory: {
    ...
    helpsPara:
      'Nora prüft die untersuchte Seite als einzelnes Content-Asset. Sie baut kein vollständiges Website-Inventar auf, crawlt keine verlinkten Seiten und klassifiziert nicht die gesamte Domain. Sie gibt Redakteuren ein nützliches Inventar-Review auf Seitenebene.',
    checks: [
    ...
    boundaryH2: 'Nora klassifiziert die Seite. Redakteure entscheiden, was daraus wird.',
    boundaryPara:
    ...
    ctaPara:
      'Nora hilft Redakteuren, das Content-Asset, seine fehlenden Signale und seine Planungsrolle zu verstehen, bevor tiefere Arbeit beginnt.',
  ...
  semantic_search_analyzer: {
    ...
    scenarios: [
      ...
      },
      {
        ...
        description: 'Sema gibt Redakteuren Abdeckungslücken zur Berücksichtigung vor dem Schreiben.',
      },
      {
    ...
    ctaPara:
      'Sema hilft Redakteuren, die thematische Tiefe mit reviewbaren semantischen Lücken zu stärken, statt Keywords zu stopfen.',
  ...
  competitor_intel: {
    ...
    problemPara:
      'Wettbewerbsorientiertes Review sollte nicht bedeuten, Ideen abzukupfern und eine andere Seite nachzuahmen. Es sollte Redakteuren helfen zu verstehen, was die Ranking-Landschaft offenbar abdeckt, was dem aktuellen Entwurf fehlt und welche Lücken wirklich relevant sind. Cassius verwandelt Wettbewerberbelege in reviewbare Content-Intelligenz.',
    ...
    scenarios: [
      ...
      },
      {
        ...
        description: 'Cassius hilft Redakteuren zu sehen, ob die Wettbewerberabdeckung vorangekommen ist.',
      },
      {
    ...
    boundaryH2: 'Cassius vergleicht die Abdeckung. Redakteure entscheiden, was genutzt wird.',
    boundaryPara:
    ...
    ctaPara:
      'Cassius hilft Redakteuren, die Abdeckung mit echten SERP-Wettbewerberbelegen zu vergleichen, ohne zu kopieren, zu raten oder Daten zu erfinden.',
