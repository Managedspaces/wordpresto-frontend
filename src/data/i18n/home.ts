...
export const homeContent: Record<Locale, HomeContent> = {
  ...
  pt: {
    ...
    hero: {
      ...
      h1Prefix: 'Word Presto é o motor de conteúdos ',
      h1Agentic: 'agêntico',
      h1Suffix: ' para escritores, editores e equipas editoriais.',
    ...
    story: {
      kicker: 'Uma nota da secretária da Word Presto',
      h2: 'Seja encontrado sem se tornar mais lixo de IA.',
      lead: 'Os seus clientes procuram em mais lugares do que nunca.',
      paragraphs: [
        'Procuram no Google, perguntam à IA, seguem recomendações e decidem que negócios merecem a sua atenção nas redes sociais.',
        'Para se manter visível, o seu negócio precisa de páginas que posicionem bem, de conteúdo que ganhe menções nas respostas de IA e de publicações nas redes sociais que as pessoas queiram mesmo ler.',
        'Mas produzir mais conteúdo não chega.',
        'A internet já está a afogar-se em artigos genéricos, respostas automáticas e publicações que soam como se ninguém acreditasse numa palavra do que dizem.',
        'O Word Presto ajuda a usar a IA sem publicar como uma máquina.',
        'Reúne a inteligência do site, o SEO, a visibilidade em IA, as campanhas nas redes sociais e a publicação numa única operação controlada por pessoas.',
        'Traga uma página existente para o Canvas. Deixe os especialistas avaliarem a sua relevância de pesquisa, estrutura, provas, voz e visibilidade em IA. Melhore-a sem perder o original. Reveja cada alteração. Aprove-a. Depois prepare-a para republicação.',
        'Crie publicações individuais para as redes sociais ou campanhas completas a partir do que o seu negócio realmente sabe. Adapte-as a cada plataforma sem retirar a personalidade. Mantenha uma pessoa no controlo antes de qualquer coisa entrar no ar.',
        'Nos bastidores, o Word Presto faz o trabalho pesado.',
        'Investiga, organiza, avalia, recomenda, redige, revê e prepara.',
        'O senhor decide o que é verdade, o que soa a si e o que merece ser publicado.',
      ],
      pullQuote: 'A IA fornece a alavancagem. As pessoas fornecem o valor.',
      closing: 'O Word Presto ajuda o seu site a posicionar-se, o seu negócio a aparecer nas respostas de IA e a sua presença nas redes sociais a crescer, sem transformar a sua marca em mais um bot de conteúdo.',
      annotation: 'leia isto duas vezes',
      signOffName: 'Emma',
      signOffRole: 'Editora-chefe · na secretária',
    },
    operatingModel: {
  ...
  'pt-br': {
    ...
    hero: {
      ...
      h1Prefix: 'Word Presto é o mecanismo de conteúdo ',
      h1Agentic: 'agêntico',
      h1Suffix: ' para escritores, editores e equipes editoriais.',
    ...
    story: {
      kicker: 'Uma nota da mesa da Word Presto',
      h2: 'Seja encontrado sem virar mais lixo de IA.',
      lead: 'Seus clientes estão buscando em mais lugares do que nunca.',
      paragraphs: [
        'Eles buscam no Google, perguntam à IA, seguem recomendações e decidem quais negócios merecem a atenção deles nas redes sociais.',
        'Para continuar visível, seu negócio precisa de páginas que ranqueiam, de conteúdo que ganha menções nas respostas de IA e de posts que as pessoas realmente querem ler.',
        'Mas produzir mais conteúdo não basta.',
        'A internet já está se afogando em artigos genéricos, respostas automáticas e posts que soam como se ninguém acreditasse em uma palavra do que dizem.',
        'O Word Presto ajuda você a usar a IA sem publicar como uma máquina.',
        'Ele reúne a inteligência do site, o SEO, a visibilidade em IA, as campanhas nas redes sociais e a publicação em uma única operação controlada por pessoas.',
        'Traga uma página existente para o Canvas. Deixe os especialistas avaliarem sua relevância de busca, estrutura, evidências, voz e visibilidade em IA. Melhore-a sem perder o original. Revise cada alteração. Aprove-a. Depois prepare-a para republicação.',
        'Crie posts individuais para as redes sociais ou campanhas completas a partir do que seu negócio realmente sabe. Adapte-os a cada plataforma sem tirar a personalidade. Mantenha uma pessoa no controle antes de qualquer coisa ir ao ar.',
        'Nos bastidores, o Word Presto faz o trabalho pesado.',
        'Ele investiga, organiza, avalia, recomenda, redige, revisa e prepara.',
        'Você decide o que é verdade, o que soa como você e o que merece ser publicado.',
      ],
      pullQuote: 'A IA fornece a alavancagem. As pessoas fornecem o valor.',
      closing: 'O Word Presto ajuda seu site a ranquear, seu negócio a aparecer nas respostas de IA e sua presença nas redes sociais a crescer, sem transformar sua marca em mais um bot de conteúdo.',
      annotation: 'leia isto duas vezes',
      signOffName: 'Emma',
      signOffRole: 'Editora-chefe · na mesa',
    },
    operatingModel: {
      eyebrow: 'O modelo operacional',
  ...
  es: {
    ...
    story: {
      kicker: 'Una nota del escritorio de Word Presto',
      h2: 'Que te encuentren sin volverte basura de IA.',
      lead: 'Tus clientes buscan en más lugares que nunca.',
      paragraphs: [
        'Buscan en Google, le preguntan a la IA, siguen recomendaciones y deciden qué negocios merecen su atención en las redes sociales.',
        'Para seguir siendo visible, tu negocio necesita páginas que posicionen, contenido que gane menciones en las respuestas de IA y publicaciones que la gente realmente quiera leer.',
        'Pero producir más contenido no basta.',
        'Internet ya se está ahogando en artículos genéricos, respuestas automáticas y publicaciones que suenan como si nadie creyera una sola palabra.',
        'Word Presto te ayuda a usar la IA sin publicar como una máquina.',
        'Reúne la inteligencia del sitio, el SEO, la visibilidad en IA, las campañas en redes sociales y la publicación en una sola operación controlada por personas.',
        'Lleva una página existente al Canvas. Deja que los especialistas evalúen su relevancia de búsqueda, estructura, evidencia, voz y visibilidad en IA. Mejórala sin perder el original. Revisa cada cambio. Apruébala. Luego prepárala para volver a publicarla.',
        'Crea publicaciones individuales para redes sociales o campañas completas a partir de lo que tu negocio realmente sabe. Adáptalas a cada plataforma sin quitarles la personalidad. Mantén a una persona al mando antes de que algo salga a la luz.',
        'Entre bastidores, Word Presto hace el trabajo pesado.',
        'Investiga, organiza, evalúa, recomienda, redacta, revisa y prepara.',
        'Tú decides qué es verdad, qué suena a ti y qué merece publicarse.',
      ],
      pullQuote: 'La IA aporta la fuerza. Las personas aportan el valor.',
      closing: 'Word Presto ayuda a que tu sitio posicione, a que tu negocio aparezca en las respuestas de IA y a que tu presencia en redes sociales crezca, sin convertir tu marca en otro bot de contenido.',
      annotation: 'lee esto dos veces',
      signOffName: 'Emma',
      signOffRole: 'Editora jefe · en el escritorio',
    },
    operatingModel: {
  ...
  de: {
    ...
    story: {
      kicker: 'Eine Notiz vom Word-Presto-Schreibtisch',
      h2: 'Gefunden werden, ohne Teil des KI-Einheitsbreis zu werden.',
      lead: 'Ihre Kunden suchen an mehr Orten als je zuvor.',
      paragraphs: [
        'Sie suchen bei Google, fragen die KI, folgen Empfehlungen und entscheiden in den sozialen Medien, welche Unternehmen ihre Aufmerksamkeit verdienen.',
        'Um sichtbar zu bleiben, braucht Ihr Unternehmen Webseiten, die ranken, Inhalte, die in KI-Antworten erwähnt werden, und Social-Media-Beiträge, die man wirklich lesen möchte.',
        'Aber mehr Inhalte zu produzieren reicht nicht.',
        'Das Internet ertrinkt bereits in generischen Artikeln, automatischen Antworten und Beiträgen, die klingen, als hätte niemand ein Wort davon geglaubt.',
        'Word Presto hilft Ihnen, KI zu nutzen, ohne wie eine Maschine zu publizieren.',
        'Es vereint Website-Intelligenz, SEO, KI-Sichtbarkeit, Social-Media-Kampagnen und Veröffentlichung in einem einzigen, von Menschen gesteuerten Ablauf.',
        'Holen Sie eine bestehende Seite in das Canvas. Lassen Sie die Spezialisten ihre Suchrelevanz, Struktur, Belege, Stimme und KI-Sichtbarkeit bewerten. Verbessern Sie sie, ohne das Original zu verlieren. Prüfen Sie jede Änderung. Geben Sie sie frei. Dann bereiten Sie sie zur erneuten Veröffentlichung vor.',
        'Erstellen Sie einzelne Social-Media-Beiträge oder ganze Kampagnen aus dem, was Ihr Unternehmen wirklich weiß. Passen Sie sie an jede Plattform an, ohne die Persönlichkeit zu verlieren. Behalten Sie einen Menschen in der Kontrolle, bevor etwas online geht.',
        'Hinter den Kulissen übernimmt Word Presto die Schwerarbeit.',
        'Es recherchiert, ordnet, bewertet, empfiehlt, entwirft, prüft und bereitet vor.',
        'Sie entscheiden, was wahr ist, was nach Ihnen klingt und was veröffentlicht werden sollte.',
      ],
      pullQuote: 'Die KI liefert die Hebelwirkung. Menschen liefern den Wert.',
      closing: 'Word Presto hilft Ihrer Website beim Ranking, Ihrem Unternehmen dabei, in KI-Antworten zu erscheinen, und Ihrer Social-Media-Präsenz beim Wachsen, ohne Ihre Marke in einen weiteren Content-Bot zu verwandeln.',
      annotation: 'zweimal lesen',
      signOffName: 'Emma',
      signOffRole: 'Chefredakteurin · am Schreibtisch',
    },
    operatingModel: {
  ...
  fr: {
    ...
    hero: {
      ...
      h1Agentic: 'agentique',
      h1Suffix: ' pour les auteurs, les rédacteurs et les équipes éditoriales.',
    ...
    story: {
      kicker: 'Un mot du bureau de Word Presto',
      h2: 'Être trouvé sans devenir de la bouillie d\'IA.',
      lead: 'Vos clients cherchent à plus d\'endroits que jamais.',
      paragraphs: [
        'Ils cherchent sur Google, interrogent l\'IA, suivent des recommandations et décident sur les réseaux sociaux quelles entreprises méritent leur attention.',
        'Pour rester visible, votre entreprise a besoin de pages qui se classent, de contenu qui gagne des mentions dans les réponses d\'IA et de publications que les gens ont vraiment envie de lire.',
        'Mais produire plus de contenu ne suffit pas.',
        'Internet se noie déjà sous les articles génériques, les réponses automatiques et les publications qui sonnent comme si personne n\'en croyait un mot.',
        'Word Presto vous aide à utiliser l\'IA sans publier comme une machine.',
        'Il réunit l\'intelligence du site, le SEO, la visibilité dans l\'IA, les campagnes sur les réseaux sociaux et la publication dans une seule opération contrôlée par des humains.',
        'Amenez une page existante dans le Canvas. Laissez les spécialistes évaluer sa pertinence de recherche, sa structure, ses sources, sa voix et sa visibilité dans l\'IA. Améliorez-la sans perdre l\'original. Relisez chaque changement. Approuvez-la. Puis préparez-la pour la republication.',
        'Créez des publications individuelles pour les réseaux sociaux ou des campagnes complètes à partir de ce que votre entreprise sait vraiment. Adaptez-les à chaque plateforme sans en retirer la personnalité. Gardez un humain aux commandes avant toute mise en ligne.',
        'En coulisses, Word Presto fait le gros du travail.',
        'Il enquête, organise, évalue, recommande, rédige, relit et prépare.',
        'Vous décidez de ce qui est vrai, de ce qui vous ressemble et de ce qui mérite d\'être publié.',
      ],
      pullQuote: 'L\'IA fournit l\'effet de levier. Les humains apportent la valeur.',
      closing: 'Word Presto aide votre site à se classer, votre entreprise à apparaître dans les réponses d\'IA et votre présence sur les réseaux sociaux à grandir, sans transformer votre marque en un énième robot à contenu.',
      annotation: 'à lire deux fois',
      signOffName: 'Emma',
      signOffRole: 'Rédactrice en chef · au bureau',
    },
    operatingModel: {
