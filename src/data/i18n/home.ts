...
export const homeContent: Record<Locale, HomeContent> = {
  ...
  es: {
    seo: {
      pageTitle: 'Word Presto es el motor de contenido inteligente para escritores, editores y equipos editoriales.',
      seoTitle: 'Motor de flujo de trabajo para escritores y equipos editoriales | Word Presto',
      metaDescription: 'Planifica, define el brief, escribe, revisa, mejora y deja el contenido listo para buscadores, lectores y el CMS.',
    },
    hero: {
      eyebrow: 'el motor de contenido que impulsa la publicación',
      h1Prefix: 'Word Presto es el',
      h1Agentic: 'motor de contenido inteligente',
      h1Suffix: 'para escritores, editores y equipos editoriales.',
      body: 'En el centro está Emma, tu editora jefe. Ella mantiene el brief, el borrador, las fuentes, el SEO, la revisión y la aprobación fluyendo en un mismo escritorio editorial tranquilo, mientras tú conservas la última palabra.',
      ...
      ctaSecondary: 'Conoce el escritorio editorial',
      demoLink: 'Mira cómo una idea en bruto se convierte en algo listo para revisar',
    ...
    board: {
      ...
      emmaSub: 'Manteniendo el brief, el borrador y la revisión en movimiento',
      preparing: 'Preparando',
      canvasLabel: 'LIENZO · guía de lanzamiento',
      workingSurface: 'la superficie de trabajo',
      chip1: 'Vera · verificando fuentes',
      chip2: 'Voz · desviándose §2',
      specialistDesk: 'Mesa especializada',
      reportsThroughEmma: 'informes a través de Emma',
      gateApproval: 'Requiere aprobación del editor',
      gateCms: 'Listo para pasar al CMS',
      stamp: 'Esperando visto bueno',
    },
    operatingModel: {
      eyebrow: 'El modelo de trabajo',
      h2: 'Esto no es otro panel de contenido.',
      body: 'La mayoría del trabajo de contenido no fracasa porque la gente no sepa escribir. Fracasa porque las instrucciones cambian, las revisiones llegan tarde, las afirmaciones pierden sus fuentes, el SEO se añade al final y nadie sabe quién aprobó qué.',
      note: 'Word Presto le da un escritorio al trabajo. Emma lo gestiona.',
      beforeLabel: 'ANTES · DISPERSO',
      beforeCards: [
        { title: 'Instrucciones vagas', body: 'Nadie acordó para qué era la página.', note: '?' },
        { title: 'La reescritura llegó tarde', body: 'Los comentarios llegaron después del borrador.' },
        { title: 'Afirmación sin evidencia', body: 'Se siguió adelante igual.', note: '¿Fuente?' },
        { title: 'Aprobación desordenada', body: '¿Quién dio el visto bueno?' },
      ],
      emmaRole: 'EDITOR JEFE',
      afterLabel: 'DESPUÉS · UN SOLO ESCRITORIO',
      afterHeader: 'El escritorio, en orden',
      afterItems: [
        'Instrucciones acordadas y archivadas',
        'SEO revisado en el borrador, no después',
        'Cada afirmación lleva su propia prueba.',
        'La aprobación final es del editor.',
      ],
    },
    emmaDesk: {
      eyebrow: 'En el centro del escritorio.',
      h2: 'Conoce a Emma, tu editora jefe.',
      badgeRole: 'EDITOR JEFE',
      badgeCity: 'DUBLÍN',
      cards: [
        { title: 'Ella lleva el caso.', body: 'Mantiene a la vista el objetivo, la audiencia, el tono, el contexto y las decisiones anteriores para que el trabajo no se desvíe.' },
        { title: 'Ella gestiona el escritorio.', body: 'Lleva cada pieza desde el resumen hasta el borrador, la corrección, la revisión y la aprobación sin perder el hilo.' },
        { title: 'Ella llama a los especialistas.', body: 'Envía las afirmaciones, el SEO, las pruebas, el tono, los enlaces, los riesgos y las tareas de traspaso al especialista adecuado en el momento justo.' },
    ...
    commitments: {
      ...
      panelTitle: 'Se aplica a cada trabajo.',
      panelLabel: 'CUATRO COMPROMISOS',
      items: [
        { num: '01', title: 'La verdad ante todo.', body: 'Nada de cifras inventadas. Nada de afirmaciones sin respaldo. Nada de hacer pasar pruebas débiles por sólidas.' },
        { num: '02', title: 'Di lo honesto.', body: 'Emma no te va a halagar si el borrador está mal. Te dice lo que necesita mejorar.' },
        { num: '03', title: 'Protege tu trabajo.', body: 'Nada se publica sin la aprobación del Editor.' },
        { num: '04', title: 'Recuerda lo que importa.', body: 'Emma aprende los estándares, el tono y las decisiones que definen el proyecto.' },
      ],
    },
    canvas: {
      eyebrow: 'La superficie de trabajo.',
      h2: 'Una sola superficie de trabajo para el texto final.',
      body: 'El Canvas es donde Emma reúne todo: páginas importadas, borradores, reescrituras, notas de corrección, hallazgos de especialistas y decisiones de aprobación.',
      points: [
      ...
      docLabel: 'launch-guide.md · editando Emma',
      draftLabel: 'BORRADOR · §1&ndash;§4',
      docHeading: 'Lanzar con confianza',
      sectionLabel: '§3 · REVISIÓN',
      ...
      footerLeft: 'Aún falta la aprobación final',
      footerRight: 'volver al Editor',
      annotation: 'una sola superficie, sin pestañas',
    },
    specialists: {
      eyebrow: 'El banco de especialistas',
      h2Suffix: 'especialistas. Un director editorial.',
      body: 'Emma no trabaja sola. Detrás de ella está todo el banco de especialistas de Word Presto: personal de producción de contenido, SEO, operaciones y control de aprobaciones, cada uno con un rol y un lugar definidos en el flujo de trabajo.',
      ...
      editorApprovalRequired: 'Requiere aprobación del editor',
      chipsLabel: 'Algunos de los especialistas que Emma puede incorporar al equipo:',
    ...
    languages: {
      eyebrow: 'Voz nativa',
      h2: 'El mismo nivel. Voz nativa.',
      body: 'Cuando trabajas en otro idioma, no te asignan una Emma traducida. Te asignan una editora jefe que gestiona esa misma sección en su propia lengua y con su propio estilo.',
      closingText: 'Seis editores. Un solo nivel.',
      editors: [
    ...
    approval: {
      eyebrow: 'La puerta',
      h2: 'Solo el editor puede dar el visto bueno al trabajo.',
      body: 'Emma prepara el trabajo, los especialistas lo revisan y el Canvas lo organiza, pero solo el editor lo aprueba.',
      finalLine: 'Nada se publica hasta que la persona responsable dice que sí.',
      docTitle: 'Aprobación',
    ...
    publish: {
      ...
      body: 'Word Presto adapta una idea aprobada en versiones listas para redes sociales, y revisa y mejora el contenido de tu web para que esté listo para entregar. Nada se publica hasta que una persona lo aprueba.',
      sourceKicker: 'Fuente aprobada por personas',
      sourceTitle: 'Contenido aprobado',
      sourceNote1: 'Claro. Preciso. Con la imagen de marca.',
      sourceNote2: 'Escribe una vez, adapta en todas partes.',
      connector: 'Preparado para',
      socialLabel: 'Redes sociales',
      cmsLabel: 'Página web y CMS',
      readyStatus: 'Listo',
      cmsStatus: 'Conectado',
      cmsNote: 'Importa, mejora y devuelve las correcciones.',
      footerLead: 'Los agentes preparan cada versión.',
      footerEmphasis: 'La decisión final la toma una persona.',
      footerTail: 'Todo pasa por la aprobación humana antes de publicarse.',
    },
    cta: {
      h2: 'Pon a Emma en el centro de tu operación de contenidos.',
      body: 'Para escritores, editores y equipos editoriales que quieren mejor contenido sin perder el control editorial.',
      ctaPrimary: 'Únete ahora',
      ctaSecondary: 'Conoce el escritorio editorial',
    ...
    footer: {
      ...
      deskLinks: ['Emma gestiona el escritorio', 'El Canvas', 'Mesa especializada'],
      standardsHeading: 'Normas',
      standardsLinks: ['Cuatro compromisos', 'Aprobación del editor', 'Voz nativa'],
      forHeading: 'Para',
      forLinks: ['Escritores', 'Editores', 'Equipos editoriales'],
      copyright: '© 2026 Word Presto',
  ...
  fr: {
    seo: {
      pageTitle: 'Word Presto, c\'est le moteur de contenu intelligent pour les auteurs, les éditeurs et les équipes de publication.',
      seoTitle: 'Moteur de flux de contenu pour les rédacteurs et les équipes éditoriales | Word Presto',
      metaDescription: 'Planifie, briefe, écris, relis, améliore et prépare ton contenu pour le référencement, les lecteurs et la transmission au CMS.',
    },
    hero: {
      eyebrow: 'le moteur de contenu qui fait tourner la publication',
      h1Prefix: 'Word Presto, c\'est',
      h1Agentic: 'intelligent',
      h1Suffix: 'le moteur de contenu pour les auteurs, les éditeurs et les équipes de publication.',
      body: 'Au centre, il y a Emma, ta rédactrice en chef. Elle fait circuler le brief, le brouillon, les sources, le SEO, la relecture et la validation sur un seul bureau éditorial apaisé, pendant que tu gardes le dernier mot.',
      approvalNoteLine1: 'Emma prépare. Le rédacteur en chef valide.',
      approvalNoteLine2: 'Rien ne part sans ton feu vert.',
      ctaPrimary: 'Rejoins-nous maintenant',
      ctaSecondary: 'Voir le bureau éditorial',
      demoLink: 'Vois une idée brute devenir prête à être relue',
      preparesLabel: 'prépare le contenu pour',
    },
    board: {
      note: 'ton bureau, coordonné',
      title: 'Tableau des opérations éditoriales',
      liveLabel: 'BUREAU · EN DIRECT',
      editorInChief: 'RÉDACTEUR EN CHEF',
      you: 'Toi',
      finalCall: 'le dernier mot',
      ...
      chip1: 'Vera · vérification des sources',
      chip2: 'Voix · dérive §2',
      specialistDesk: 'Pôle spécialisé',
      reportsThroughEmma: 'articles relayés par Emma',
      gateApproval: 'Nécessite l\'approbation du rédacteur en chef',
      gateCms: 'Prêt pour le transfert vers le CMS',
      stamp: 'En attente du feu vert',
    },
    operatingModel: {
      eyebrow: 'Le mode de fonctionnement',
      h2: 'Ce n\'est pas un énième tableau de bord de contenu.',
      body: 'La plupart des projets de contenu échouent, non pas parce que les gens ne savent pas écrire, mais parce que le brief change, les relectures arrivent en retard, les sources des affirmations se perdent, le SEO est bricolé à la dernière minute, et personne ne sait qui a validé quoi.',
      note: 'Word Presto offre un bureau dédié au travail. C\'est Emma qui le tient.',
      beforeLabel: 'AVANT · DISPERSÉ',
      beforeCards: [
        { title: 'Brief flou', body: 'Personne ne s\'est mis d\'accord sur l\'objectif de la page.', note: '?' },
        { title: 'Réécriture arrivée en retard', body: 'Les remarques sont arrivées après la rédaction du brouillon.' },
        { title: 'Affirmation sans preuve', body: 'On a avancé quand même.', note: 'Source ?' },
        { title: 'Validation en pagaille', body: 'Qui a donné son accord pour ça ?' },
      ],
      emmaRole: 'RÉDACTEUR EN CHEF',
      ...
      afterItems: [
        ...
        'Les affirmations s’appuient sur des preuves',
        'C’est le rédacteur en chef qui donne son feu vert',
      ],
    },
    emmaDesk: {
      eyebrow: 'Au cœur du bureau',
      h2: 'Voici Emma, ta rédactrice en chef.',
      badgeRole: 'RÉDACTEUR EN CHEF',
      badgeCity: 'DUBLIN',
      cards: [
        { title: 'C’est elle qui tient le brief', body: 'Elle garde en tête l’objectif, le public, le ton, le contexte et les décisions passées, pour que le travail reste sur les rails.' },
        { title: 'Elle tient le bureau', body: 'Elle fait passer chaque texte du brief au brouillon, à la relecture, à la révision et à la validation, sans jamais perdre le fil.' },
        { title: 'Elle fait appel aux spécialistes', body: 'Elle envoie les affirmations, le SEO, les preuves, le ton, les liens, les risques et les tâches de transition au bon spécialiste au bon moment.' },
        { title: 'Elle protège ton autorité', body: 'Emma peut recommander et préparer. Seul le rédacteur en chef peut approuver.' },
      ],
    },
    commitments: {
      eyebrow: 'La constitution éditoriale',
      h2: 'Les quatre engagements d’Emma.',
      body: 'Les standards qu’Emma applique à chaque travail : les règles qui rendent le bureau digne de confiance.',
      panelTitle: 'Appliqué à chaque travail',
      panelLabel: 'QUATRE ENGAGEMENTS',
      items: [
        { num: '01', title: 'La vérité terrain avant tout', body: 'Pas de chiffres inventés. Pas d’affirmations sans fondement. Pas de preuves faibles présentées comme solides.' },
        { num: '02', title: 'Dis les choses honnêtement', body: 'Emma ne va pas flatter un mauvais brouillon. Elle te dit ce qui doit être amélioré.' },
        { num: '03', title: 'Protège ton travail', body: 'Rien n’est publié sans la validation de l’Éditeur.' },
        { num: '04', title: 'N’oublie pas ce qui compte', body: 'Emma apprend les standards, le ton et les décisions qui façonnent le projet.' },
      ],
    },
    canvas: {
      eyebrow: 'La surface de travail',
      h2: 'Un seul espace de travail pour le texte final.',
      body: 'Le Canvas, c\'est là où Emma rassemble tout : pages importées, brouillons, réécritures, notes de relecture, retours d\'experts et décisions d\'approbation.',
      points: [
        'Importe, rédige, réécris, relis et valide, tout au même endroit.',
        'Les retours des spécialistes arrivent dans les notes en marge, pas en réunion.',
        'L\'approbation finale reste obligatoire, toujours.',
      ],
      docLabel: 'launch-guide.md · Emma en train d\'éditer',
      draftLabel: 'BROUILLON · §1&ndash;§4',
      docHeading: 'Se lancer en toute confiance',
      sectionLabel: '§3 · RELECTURE',
      marginLabel: 'NOTES EN MARGE',
      marginNotes: [
        { tag: 'AFFIRMATIONS', text: 'Cette affirmation a besoin d\'une source avant d\'être approuvée.' },
        { tag: 'BRIEF', text: 'Cette partie s\'éloigne du brief.' },
        { tag: 'TON', text: 'Le ton est trop générique ici.' },
        { tag: 'MÉTADONNÉES', text: 'L\'option B pour les métadonnées est la plus forte.' },
      ],
      footerLeft: 'Approbation finale encore requise',
      footerRight: 'retour à l\'éditeur',
      annotation: 'un seul espace, pas d\'onglets',
    },
    specialists: {
      eyebrow: 'Le pôle des spécialistes',
      h2Suffix: 'spécialistes. Un rédacteur en chef.',
      body: 'Emma ne travaille pas seule. Derrière elle, il y a tout le pôle de spécialistes Word Presto : production de contenu, SEO, opérations et validation, chacun avec un rôle précis dans le flux de travail.',
      ...
      editorApprovalRequired: 'Nécessite l\'approbation du rédacteur en chef',
      chipsLabel: 'Voici quelques spécialistes qu\'Emma peut faire intervenir :',
      browseProfiles: 'Consulter les profils des spécialistes',
      teamLabel: 'ÉQUIPE',
    ...
    languages: {
      eyebrow: 'Voix native',
      h2: 'Même exigence. Voix native.',
      body: 'Quand tu travailles dans une autre langue, Emma n\'est pas traduite. Tu as une rédactrice en chef qui tient la même rubrique dans sa propre langue et avec ses propres expressions.',
      closingText: 'Six rédacteurs. Un seul niveau d\'exigence.',
      editors: [
    ...
    approval: {
      eyebrow: 'Le portail',
      h2: 'Seul le rédacteur en chef peut valider le travail.',
      body: 'Emma peut préparer le boulot. Les spécialistes peuvent le relire. Le Canvas peut l\'organiser. Mais seul le rédacteur en chef peut donner son feu vert.',
      finalLine: 'Rien ne part en ligne tant que le responsable humain n\'a pas dit oui.',
      docTitle: 'Validation',
      filename: 'guide-de-lancement.md',
      row1: 'Résumé du bureau d’Emma',
      row1Status: 'Prêt',
      row2: 'Relecture par les spécialistes',
      row2Status: 'Dans',
      row3: 'Feu vert du rédacteur',
      row3Status: 't\'attend',
      approvedByLabel: 'validé par',
      stampText: 'Validé',
      pillText: 'C\'est le rédacteur en chef qui a le dernier mot',
    },
    publish: {
      eyebrow: 'Écris une fois · Publie partout',
      h2: 'Une idée validée, prête pour tous les canaux.',
      body: 'Word Presto transforme une idée approuvée en versions prêtes à publier sur les réseaux sociaux, et révise le contenu déjà sur ton site pour l\'améliorer avant transmission. Rien ne part en ligne sans l\'accord d\'une personne.',
      sourceKicker: 'Source validée par un humain',
      sourceTitle: 'Contenu approuvé',
      sourceNote1: 'Clair. Précis. Dans le ton de la marque.',
      sourceNote2: 'Écris une fois, adapte partout.',
      connector: 'Préparé pour',
      socialLabel: 'Réseaux sociaux',
      cmsLabel: 'Site web et CMS',
      readyStatus: 'Prêt',
      cmsStatus: 'Connecté',
      cmsNote: 'Importe, améliore, puis renvoie les corrections.',
      footerLead: 'Les agents préparent chaque version.',
      footerEmphasis: 'C\'est toujours les humains qui décident',
      footerTail: 'Rien ne part en ligne sans validation humaine.',
    },
    cta: {
      h2: 'Mets Emma au centre de ta production de contenu.',
      body: 'Pour les auteurs, rédacteurs et équipes éditoriales qui veulent un meilleur contenu sans perdre la main.',
      ctaPrimary: 'Rejoins-nous maintenant',
      ctaSecondary: 'Voir le bureau éditorial',
    ...
    footer: {
      ...
      deskLinks: ['Emma gère le bureau', 'Le Canvas', 'Pôle spécialisé'],
      standardsHeading: 'Les standards',
      standardsLinks: ['Quatre engagements', 'Validation éditoriale', 'Voix native'],
      forHeading: 'Pour',
      forLinks: ['Auteurs', 'Rédacteurs', 'Équipes éditoriales'],
      copyright: '© 2026 Word Presto',
      tagline2: 'Emma prépare · le rédacteur valide',
    },
  },
};
