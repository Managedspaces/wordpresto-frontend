...
export const homeContent: Record<Locale, HomeContent> = {
  ...
  pt: {
    ...
    publish: {
      ...
      body: 'A Word Presto adapta uma ideia aprovada em versões prontas para as redes sociais e revê e melhora o conteúdo que já existe no seu site, pronto para entrega. Nada é publicado até uma pessoa aprovar.',
      ...
      readyStatus: 'Pronto',
      cmsStatus: 'Ligado',
      cmsNote: 'Importe, melhore e devolva as correções.',
  ...
  'pt-br': {
    ...
    publish: {
      ...
      h2: 'Uma ideia aprovada, pronta para cada canal.',
      body: 'A Word Presto adapta uma ideia aprovada em versões prontas para as redes sociais e revisa e melhora o conteúdo que já existe no seu site, pronto para entrega. Nada vai ao ar até uma pessoa aprovar.',
      sourceKicker: 'Fonte aprovada por humanos',
      sourceTitle: 'Conteúdo aprovado',
  ...
  de: {
    ...
    publish: {
      ...
      body: 'Word Presto passt eine freigegebene Idee in kanalfertige Versionen für Social Media an und prüft und verbessert die Inhalte, die bereits auf Ihrer Website sind, bereit zur Übergabe. Nichts geht live, bevor ein Mensch es freigibt.',
      ...
      readyStatus: 'Bereit',
      cmsStatus: 'Verbunden',
      cmsNote: 'Inhalte importieren, verbessern und Korrekturen zurückgeben.',
