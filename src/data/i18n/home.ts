...
export const homeContent: Record<Locale, HomeContent> = {
  ...
  de: {
    seo: {
      pageTitle: 'Word Presto ist die agentische Content-Engine für Autor:innen, Redakteur:innen und Publishing-Teams.',
      seoTitle: 'Content-Workflow-Engine für Autor:innen und Publishing-Teams | Word Presto',
      metaDescription: 'Planen, briefen, schreiben, prüfen, verbessern und Inhalte für Suche, Leser:innen und CMS-Übergabe vorbereiten.',
    },
    hero: {
      eyebrow: 'die Content-Engine hinter besserem Publizieren',
      h1Prefix: 'Word Presto ist die ',
      h1Agentic: 'agentische',
      h1Suffix: ' Content-Engine für Autor:innen, Redakteur:innen und Publishing-Teams.',
    ...
    board: {
      ...
      specialistDesk: 'Spezialist:innen-Team',
    ...
    emmaDesk: {
      ...
      cards: [
        ...
        { title: 'Sie holt die Spezialist:innen', body: 'Schickt Arbeit zu Behauptungen, SEO, Belegen, Stimme, Links, Risiko und Übergabe zur richtigen Zeit an die richtige Spezialistin.' },
    ...
    canvas: {
      ...
      body: 'Im Canvas bringt Emma die Arbeit zusammen: importierte Seiten, Entwürfe, Überarbeitungen, Korrekturnotizen, Erkenntnisse der Spezialist:innen und Freigabeentscheidungen.',
      points: [
    ...
    specialists: {
      eyebrow: 'Das Spezialist:innen-Team',
      h2Suffix: ' Spezialist:innen. Eine Chefredakteurin.',
      body: 'Emma arbeitet nicht allein. Hinter ihr steht das gesamte Word-Presto-Spezialist:innen-Team: Content-Produktion, SEO, Betrieb und Freigabe-Governance, jede und jeder mit klar definierter Rolle und Platz im Workflow.',
    ...
    approval: {
      ...
      body: 'Emma kann die Arbeit vorbereiten. Spezialist:innen können sie reviewen. Das Canvas kann sie organisieren. Aber nur der Editor kann sie freigeben.',
    ...
    cta: {
      ...
      body: 'Für Autor:innen, Redakteur:innen und Publishing-Teams, die bessere Content-Arbeit wollen, ohne die redaktionelle Kontrolle abzugeben.',
      ctaPrimary: 'Warteliste beitreten',
      ctaSecondary: 'Die Redaktion ansehen',
    ...
    footer: {
      ...
      deskLinks: ['Emma leitet die Redaktion', 'Das Canvas', 'Spezialist:innen-Team'],
      standardsHeading: 'Standards',
      standardsLinks: ['Vier Grundsätze', 'Freigabe durch Editor', 'Muttersprachliche Stimme'],
      forHeading: 'Für',
      forLinks: ['Autor:innen', 'Redakteur:innen', 'Publishing-Teams'],
      copyright: '© 2026 Word Presto',
