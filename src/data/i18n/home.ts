...
export const homeContent: Record<Locale, HomeContent> = {
  ...
  pt: {
    ...
    hero: {
      ...
      ctaPrimary: 'Comece o seu teste gratuito de 7 dias',
  ...
  'pt-br': {
    ...
    hero: {
      ...
      approvalNoteLine2: 'Nada é publicado sem a sua aprovação.',
      ctaPrimary: 'Comece seu teste gratuito de 7 dias',
  ...
  es: {
    ...
    hero: {
      ...
      ctaPrimary: 'Empieza tu prueba gratis de 7 días',
  ...
  de: {
    seo: {
      pageTitle: 'Der intelligente Workflow für professionelles Publizieren.',
      seoTitle: 'Der intelligente Workflow für professionelles Publizieren | Word Presto',
      metaDescription: 'Planen, briefen, verfassen, überprüfen, verbessern, SEO optimieren und veröffentlichen.',
    },
    hero: {
      eyebrow: 'KI schreibt Texte. Word Presto veröffentlicht.',
      h1Prefix: 'Der ',
      h1Agentic: 'intelligente',
      h1Suffix: ' Workflow für professionelles Publizieren.',
      body: 'Im Mittelpunkt steht Emma, Ihre KI-Chefredakteurin. Sie steuert Briefing, Entwurf, Quellen, SEO, Qualitätsprüfung und Freigabe in einem einzigen, übersichtlichen Arbeitsbereich, während Sie das letzte Wort behalten.',
      approvalNoteLine1: 'Emma bereitet vor. Sie genehmigen.',
      approvalNoteLine2: 'Ohne Ihre Freigabe wird nichts veröffentlicht.',
      ctaPrimary: 'Starten Sie Ihre kostenlose 7-tägige Testphase',
      ctaSecondary: 'Redaktionszentrale ansehen',
      demoLink: 'Erleben Sie, wie aus ersten Ideen ein strukturiertes Manuskript entsteht',
    ...
    board: {
      ...
      you: 'Sie',
      finalCall: 'Finale Entscheidung',
      emmaRole: 'KI-CHEFREDAKTEURIN',
      emmaSub: 'Steuert Briefing, Entwurf und Freigabeprozess',
      preparing: 'In Vorbereitung',
      canvasLabel: 'CANVAS · Leitfaden für Herausgeber',
      workingSurface: 'Arbeitsbereich',
      chip1: 'Vera · Prüfung von Aussagen',
      chip2: 'Tonalität · Abweichung von §2',
      specialistDesk: 'EXPERTEN',
      reportsThroughEmma: 'Berichte an Emma',
      gateApproval: 'Redaktionelle Freigabe erforderlich',
      gateCms: 'Bereit für die Veröffentlichung',
      stamp: 'Wartet auf Freigabe',
    },
    operatingModel: {
      eyebrow: 'So arbeitet Word Presto',
      h2: 'Dies ist kein weiteres Content-Dashboard.',
      body: 'Die meisten Content-Projekte scheitern nicht am Schreiben. Sie scheitern daran, dass Anforderungen sich ändern, Rückmeldungen zu spät kommen, Quellen verloren gehen, SEO erst kurz vor der Veröffentlichung berücksichtigt wird und am Ende niemand mehr weiß, wer die Freigabe erteilt hat.',
      note: 'Word Presto bringt all diese Arbeit an einem zentralen Ort zusammen. Emma koordiniert den gesamten Prozess.',
      beforeLabel: 'VORHER · UNKOORDINIERT',
      beforeCards: [
        { title: 'Unklarer Auftrag', body: 'Niemand hatte ein gemeinsames Verständnis vom Ziel der Website.', note: '?' },
        { title: 'Feedback kam zu spät', body: 'Rückmeldungen erfolgten erst nach dem ersten Entwurf.' },
        { title: 'Aussagen ohne Belege', body: 'Behauptungen wurden übernommen, obwohl Nachweise fehlten.', note: 'Quelle?' },
        { title: 'Unklare Freigaben', body: 'Niemand wusste, wer den Inhalt letztlich freigegeben hatte.' },
      ],
      emmaRole: 'KI-CHEFREDAKTEURIN',
      afterLabel: 'NACHHER · EIN ZENTRALER ARBEITSPLATZ',
      afterHeader: 'Alles an einem Ort. Klar organisiert.',
      afterItems: [
        'Ziele und Briefing sind abgestimmt und dokumentiert',
        'SEO wird bereits im Entwurf geprüft',
        'Aussagen werden vor der Freigabe mit Quellen belegt',
        'Die Freigabe erfolgt durch die Redaktion',
      ],
    },
    emmaDesk: {
      ...
      badgeCity: 'DUBLIN',
      cards: [
        { title: 'Sie behält den Überblick', body: 'Emma kennt Ziel, Zielgruppe, Tonalität, Kontext und bisherige Entscheidungen. So bleibt jeder Inhalt auf Kurs.' },
        { title: 'Sie steuert den Redaktionsprozess', body: 'Vom Briefing über den Entwurf, das Korrekturlesen und die Prüfung bis zur Freigabe sorgt Emma dafür, dass jeder Schritt nahtlos ineinandergreift.' },
        { title: 'Sie bindet die richtigen Experten ein', body: 'Ob SEO, Quellenprüfung, Links, Risiken oder fachliche Rückfragen, Emma bezieht die passenden Spezialisten genau dann ein, wenn sie gebraucht werden.' },
        { title: 'Sie unterstützt Ihre Entscheidungen', body: 'Emma bereitet Inhalte vor, gibt Empfehlungen und koordiniert den Prozess. Die finale Freigabe liegt immer bei Ihnen, der verantwortlichen Chefredaktion.' },
      ],
    },
    commitments: {
      eyebrow: 'Die Leitprinzipien der Redaktion',
      h2: 'Emmas vier Grundsätze.',
      body: 'Die Grundsätze leiten Emma bei jedem Auftrag. Sie bilden die Grundlage für einen verlässlichen und nachvollziehbaren Redaktionsprozess.',
      panelTitle: 'Bei jedem Auftrag',
      panelLabel: 'VIER VERBINDLICHE STANDARDS',
      items: [
        { num: '01', title: 'Fakten vor Vermutungen', body: 'Keine erfundenen Zahlen. Keine unbelegten Behauptungen. Keine schwachen Quellen, die als belastbare Belege ausgegeben werden.' },
        { num: '02', title: 'Ehrliches Feedback', body: 'Emma beschönigt keinen Entwurf. Sie zeigt klar auf, was überzeugt und was vor der Freigabe noch verbessert werden muss.' },
        { num: '03', title: 'Klare Verantwortung', body: 'Kein Inhalt wird veröffentlicht, ohne dass Sie, die verantwortliche Chefredaktion, ihn freigegeben haben.' },
        { num: '04', title: 'Den Kontext bewahren', body: 'Emma berücksichtigt die Ziele, Standards, Tonalität und bisherigen Entscheidungen Ihres Projekts, damit neue Inhalte konsequent und konsistent bleiben.' },
      ],
    },
    canvas: {
      eyebrow: 'Der Canvas',
      h2: 'Ein zentraler Arbeitsbereich für Ihre Inhalte.',
      body: 'Im Canvas führt Emma alle Arbeitsergebnisse zusammen: importierte Inhalte, Entwürfe, Überarbeitungen, Korrekturanmerkungen, fachliche Prüfungen und Freigaben.',
      points: [
        'Importieren, schreiben, überarbeiten, lektorieren und prüfen, alles in einem gemeinsamen Arbeitsbereich.',
        'Fachliche Hinweise erscheinen direkt im Dokument, nicht in langen Besprechungen oder Kommentarspalten.',
        'Jede Veröffentlichung erfordert eine abschließende redaktionelle Freigabe.',
      ],
      docLabel: 'Herausgeber-Leitfaden.md · Bearbeitung durch Emma',
      draftLabel: 'ENTWURF · §1&ndash;§4',
      docHeading: 'Mit Zuversicht starten',
      sectionLabel: '§3 · KORREKTUR',
      marginLabel: 'HINWEISE',
      marginNotes: [
        { tag: 'QUELLEN', text: 'Diese Aussage benötigt einen belastbaren Nachweis, bevor sie freigegeben werden kann.' },
        { tag: 'BRIEFING', text: 'Dieser Abschnitt weicht vom vereinbarten Briefing ab.' },
        { tag: 'TONALITÄT', text: 'Die Formulierung ist zu allgemein und entspricht nicht der gewünschten Tonalität.' },
        { tag: 'METADATEN', text: 'Variante B ist am stärksten.' },
      ],
      footerLeft: 'Die finale Freigabe steht noch aus.',
      footerRight: 'Zurück zum Experten',
      annotation: 'alles an einem Ort',
    },
    specialists: {
      eyebrow: 'Das Expertenteam',
      h2Suffix: ' Spezialisten. Eine Redaktionsleitung.',
      body: 'Emma arbeitet nicht allein. Hinter ihr steht das gesamte Word-Presto-Expertenteam: Spezialisten aus den Bereichen Content, SEO, Redaktionsprozesse und Qualitätssicherung. Jede Rolle ist klar definiert und genau dort eingebunden, wo sie im Arbeitsprozess den größten Mehrwert schafft.',
      note: 'Emma bindet zur richtigen Zeit die richtigen Spezialisten ein und führt deren Erkenntnisse wieder zusammen. So erhält die Redaktion eine fundierte Grundlage für ihre Entscheidungen, ohne die Verantwortung aus der Hand zu geben.',
      teamsSuffix: ' Teams',
      coordinatedThroughEmma: 'koordiniert durch Emma',
      editorApprovalRequired: 'Redaktionelle Freigabe erforderlich',
      chipsLabel: 'Einige der Spezialisten, die Emma hinzuziehen kann:',
      browseProfiles: 'Spezialistenprofile durchsuchen',
      teamLabel: 'TEAM',
      specialistSingular: 'SPEZIALIST',
      specialistPlural: 'SPEZIALISTEN',
    },
    languages: {
      eyebrow: 'Muttersprachliche Redaktion',
      h2: 'Gleiche Standards. In jeder Sprache.',
      body: 'Arbeiten Sie in einer anderen Sprache, erhalten Sie keine übersetzte Version von Emma. Sie bekommen eine leitende Redakteurin, die dieselben redaktionellen Standards anwendet, mit dem Sprachgefühl, den kulturellen Nuancen und den Konventionen ihrer Sprache.',
      closingText: 'Sechs Redaktionsleitungen. Ein gemeinsamer Qualitätsstandard.',
      editors: [
    ...
    approval: {
      eyebrow: 'Die finale Freigabe',
      h2: 'Die Entscheidung liegt bei der Redaktion.',
      body: 'Emma bereitet Inhalte vor. Spezialisten prüfen sie. Das Canvas führt alle Informationen an einem Ort zusammen. Die endgültige Freigabe liegt jedoch immer bei der verantwortlichen Redaktion.',
      finalLine: 'Kein Inhalt wird veröffentlicht, bevor die finale Freigabe erteilt wurde.',
      docTitle: 'Freigabe',
      filename: 'Herausgeber-Leitfaden.md',
      row1: 'Emmas redaktionelle Zusammenfassung',
      row1Status: 'Abgeschlossen',
      row2: 'Fachliche Prüfungen',
      row2Status: 'Abgeschlossen',
      row3: 'Redaktionelle Freigabe',
      row3Status: 'Ausstehend',
      approvedByLabel: 'genehmigt von',
      stampText: 'Genehmigt',
      pillText: 'die Redaktion entscheidet',
    },
    publish: {
      eyebrow: 'Einmal erstellen · Überall veröffentlichen',
      h2: 'Ein Inhalt. Bereit für jeden Kanal.',
      body: 'Word Presto erstellt aus einem redaktionell freigegebenen Inhalt passgenaue Versionen für soziale Medien. Bestehende Inhalte Ihrer Website können übernommen, geprüft und optimiert werden, bereit für die Übergabe an Ihr CMS. Veröffentlicht wird erst nach der redaktionellen Freigabe.',
      sourceKicker: 'Redaktionell freigegebene Version',
      sourceTitle: 'Genehmigte Inhalte',
      sourceNote1: 'Klar. Präzise. Markenkonform.',
      sourceNote2: 'Einmal erstellen. Für jeden Kanal bereit.',
      connector: 'Bereit für',
      socialLabel: 'Soziale Medien',
      cmsLabel: 'Website & CMS',
      readyStatus: 'Bereit',
      cmsStatus: 'Verbunden',
      cmsNote: 'Inhalte übernehmen, optimieren und Änderungen zurückführen.',
      footerLead: 'Emma und ihre Spezialisten bereiten jede Version vor.',
      footerEmphasis: 'Die Entscheidung über die Veröffentlichung bleibt bei Ihrer Redaktion',
      footerTail: 'Jeder Inhalt wird erst nach der abschließenden redaktionellen Freigabe veröffentlicht.',
    },
    cta: {
      h2: 'Machen Sie Emma zum Zentrum Ihrer Redaktion.',
      body: 'Für Autoren, Redaktionen und Content-Teams, die hochwertige Inhalte erstellen möchten, mit der Unterstützung von KI und der Sicherheit einer redaktionellen Freigabe.',
  ...
  fr: {
    ...
    hero: {
      ...
      ctaPrimary: 'Commencez votre essai gratuit de 7 jours',
