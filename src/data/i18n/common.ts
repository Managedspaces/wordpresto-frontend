...
export const commonStrings: Record<Locale, CommonStrings> = {
  ...
  fr: {
    ...
    astroCms: 'Astro + versions CMS',
    cmsConnected: 'Connecté à un CMS',
    standaloneEngine: 'Moteur autonome',
    footerTagline: 'Le moteur de contenu qui améliore tes processus de publication.',
    reviewLed: 'Publication avec relecture · Validation humaine',
  },
};
