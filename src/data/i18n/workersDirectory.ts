...
export const workersHubContent: Record<Locale, WorkersHubContent> = {
  ...
  de: {
    seoTitle: 'Content-Workflow-Workers | WordPresto',
    metaDescription: 'Lernen Sie die spezialisierten Workers im Content-Workflow von WordPresto kennen, von Content-Analyse und Briefing-Erstellung bis hin zu Stilprüfung, Freigabeberichten und CMS-Übergabe.',
    h1: 'Spezialisierte Workers für jede Phase des Content-Workflows.',
    intro: 'Word Presto zieht die passenden Spezialisten für die jeweilige Phase hinzu, damit jeder Content genau die Unterstützung bekommt, die er wirklich braucht.',
    eyebrow: 'Das Team',
    directoryLabel: 'WORKER-VERZEICHNIS',
    rolesCountSuffix: ' SPEZIALISTENROLLEN · EIN CONTENT-WORKFLOW',
    crosslinkLabel: 'Ebenfalls im Workflow',
    crosslinkTitle: 'SEO-Workers, in ihrem eigenen Verzeichnis',
    crosslinkCta: 'Die SEO-Workers ansehen',
  },
  fr: {
