...
export const workersHubContent: Record<Locale, WorkersHubContent> = {
  ...
  fr: {
    ...
    metaDescription: 'Fais connaissance avec les Workers spécialisés du flux de contenu WordPresto : de l\'analyse du contenu et la rédaction du brief jusqu\'à la validation du ton, les rapports d\'approbation et la remise au CMS.',
    h1: 'Des Workers spécialisés pour chaque étape de ton flux de contenu.',
    intro: 'WordPresto fait appel aux bons spécialistes selon l\'étape où tu te trouves, pour que chaque contenu reçoive exactement le soutien dont il a besoin.',
    eyebrow: 'L\'équipe',
    directoryLabel: 'RÉPERTOIRE DES WORKERS',
    rolesCountSuffix: 'RÔLES SPÉCIALISÉS · UN SEUL FLUX DE CONTENU',
    crosslinkLabel: 'Également dans le flux',
    crosslinkTitle: 'Les Workers SEO, dans leur propre répertoire',
