...
export const workersHubContent: Record<Locale, WorkersHubContent> = {
  ...
  pt: {
    seoTitle: 'Fluxo de trabalho de conteúdos Workers | WordPresto',
    metaDescription: 'Conheça os Workers especialistas no fluxo de trabalho de conteúdos do WordPresto, desde a análise de conteúdos e a criação de briefings até à revisão do tom de voz, relatórios de aprovação e entrega ao CMS.',
    h1: 'Workers especialistas para cada etapa do fluxo de trabalho de conteúdos.',
    intro: 'O WordPresto reúne os especialistas certos para a fase em que se encontra, para que cada conteúdo receba o apoio de que realmente precisa.',
    eyebrow: 'A equipa',
    directoryLabel: 'DIRETÓRIO DE WORKERS',
    rolesCountSuffix: 'FUNÇÕES ESPECIALIZADAS · UM FLUXO DE TRABALHO DE CONTEÚDO',
    crosslinkLabel: 'Também no fluxo de trabalho',
    crosslinkTitle: 'SEO Workers, no seu próprio diretório',
    crosslinkCta: 'Consulte os SEO Workers',
  },
  'pt-br': {
    seoTitle: 'Fluxo de trabalho de conteúdo Workers | WordPresto',
    metaDescription: 'Conheça os Workers especialistas no fluxo de trabalho de conteúdo do WordPresto, desde a análise de conteúdo e elaboração de briefings até a revisão de tom de voz, relatórios de aprovação e entrega ao CMS.',
    h1: 'Workers especialistas para cada etapa do fluxo de trabalho de conteúdo.',
    intro: 'O WordPresto reúne os especialistas certos para a fase em que você está, para que cada conteúdo receba o suporte de que realmente precisa.',
    eyebrow: 'A equipe',
    directoryLabel: 'DIRETÓRIO DE WORKERS',
    rolesCountSuffix: 'FUNÇÕES ESPECIALIZADAS · UM FLUXO DE TRABALHO DE CONTEÚDO',
    crosslinkLabel: 'Também no fluxo de trabalho',
    crosslinkTitle: 'SEO Workers, em seu próprio diretório',
    crosslinkCta: 'Consulte os SEO Workers',
  },
  es: {
    seoTitle: 'Flujo de trabajo de contenido Workers | WordPresto',
    metaDescription: 'Conoce a los Workers especialistas en el flujo de trabajo de contenido de WordPresto, desde el análisis de contenido y la creación de briefs hasta la revisión de voz, los informes de aprobación y la entrega al CMS.',
    h1: 'Workers especializados para cada etapa del flujo de trabajo de contenido.',
    intro: 'WordPresto incorpora a los especialistas adecuados para la fase en la que te encuentras, para que cada contenido reciba el apoyo que realmente necesita.',
    eyebrow: 'El equipo',
    directoryLabel: 'DIRECTORIO DE WORKERS',
    rolesCountSuffix: 'ROLES ESPECIALIZADOS · UN ÚNICO FLUJO DE TRABAJO DE CONTENIDO',
    crosslinkLabel: 'También en el flujo de trabajo',
    crosslinkTitle: 'SEO Workers, en su propio directorio',
    crosslinkCta: 'Echa un vistazo a los SEO Workers',
  },
  de: {
    seoTitle: 'Content-Workflow-Workers | WordPresto',
